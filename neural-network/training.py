...
class Training:
  ...
  def futhark_main(self, wih_mem_13440, who_mem_13441, inputs_mem_13442,
    ...
    assert empty_or_match_11079, ("Error: %s\n\nBacktrace:\n-> #0  Training.fut:3:19-30\n   #1  Training.fut:8:21-38\n   #2  Training.fut:8:3-9:17\n   #3  Training.fut:17:19-34\n   #4  Training.fut:17:3-37\n   #5  Training.fut:159:25-38\n   #6  Training.fut:157:1-178:33\n" % ("function arguments of wrong shape",))
    ...
    assert empty_or_match_11127, ("Error: %s\n\nBacktrace:\n-> #0  Training.fut:130:3-21\n   #1  Training.fut:167:25-58\n   #2  Training.fut:157:1-178:33\n" % ("function arguments of wrong shape",))
    ...
    assert empty_or_match_11133, ("Error: %s\n\nBacktrace:\n-> #0  Training.fut:122:3-14\n   #1  /futlib/soacs.fut:51:19-23\n   #2  /futlib/soacs.fut:51:3-37\n   #3  Training.fut:130:3-21\n   #4  Training.fut:167:25-58\n   #5  Training.fut:157:1-178:33\n" % ("function arguments of wrong shape",))
    ...
    assert empty_or_match_11181, ("Error: %s\n\nBacktrace:\n-> #0  Training.fut:98:3-15\n   #1  Training.fut:173:23-89\n   #2  Training.fut:157:1-178:33\n" % ("function arguments of wrong shape",))
    empty_or_match_cert_11184 = True
    assert empty_or_match_11102, ("Error: %s\n\nBacktrace:\n-> #0  Training.fut:90:3-14\n   #1  /futlib/soacs.fut:51:19-23\n   #2  /futlib/soacs.fut:51:3-37\n   #3  Training.fut:98:3-15\n   #4  Training.fut:173:23-89\n   #5  Training.fut:157:1-178:33\n" % ("function arguments of wrong shape",))
    ...
    assert empty_or_match_11196, ("Error: %s\n\nBacktrace:\n-> #0  Training.fut:66:3-20\n   #1  Training.fut:175:30-69\n   #2  Training.fut:157:1-178:33\n" % ("function arguments of wrong shape",))
